...
export default class HomeScreen extends Component {
    ...
    //     fetch('https://www.food2fork.com/api/search?key=8de0591500e865145cfdc77e93a33221')
   ...
   //   .catch((error) => this.setState({loading:false}));
    ...
    renderHeader=() => {
       return(
       <TextInput
          style={{ height:40, borderColor: 'gray', borderWidth: 1, padding:10, marginHorizontal:15, marginTop:20,}}
